        ...
        <div className="glass rounded-3xl p-12 shadow-2xl">
            <div className="flex flex-col items-center justify-center space-y-6">
                ...
                <div className="text-center">
                    <h3 className="text-2xl font-bold text-white mb-2">Analyzing Account...</h3>
                    <p className="text-white/70">Our AI is processing the data</p>
                </div>
                ...
                <div className="w-full max-w-sm space-y-3">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-white/80 text-sm">Extracting features...</span>
                    </div>
                    <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-yellow-400 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                        <span className="text-white/80 text-sm">Computing risk signals...</span>
                    </div>
                    <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-purple-400 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                        <span className="text-white/80 text-sm">Generating report...</span>
                    </div>
                </div>
